...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id :
        order = await event.reply('اهلا مطوري سيد سنترال - @f_fllf')
...
async def update(event):
    ...
    await sedthon.send_message("me", "اكتملت  اعادة تشغيل  سورس العراق سورس !")
